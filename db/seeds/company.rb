...
Company.create({"name"=>"Santa Casa de Birigui", "fancy_name"=>"Santa casa", "cnpj"=>"11.111.111/1111-11", "responsible"=>"Roberto", "address_attributes"=>{"zip_code"=>16201010, "number"=>41257, "street"=>"R. Dr. Carlos Carvalho Rosa", "neighborhood"=>"Patrimônio Silvares", "city"=>"Birigui", "state"=>"São Paulo", "complement"=>"", "loc"=>[-21.2825835, -50.33602689999998]}, "contact_attributes"=>{"ddd_phone"=>"18", "phone"=>"11 1111 1111", "ddd_cellphone"=>"18", "cellphone"=>"11 1111 1111", "email"=>"santacasa@teste.com.br"}, "user_attributes"=>{"email"=>"santacasa@doando.se", "password"=>"123123", "password_confirmation"=>"123123"}})
Company.create({"name"=>"Centro Médico de Birigui", "fancy_name"=>"Centro Médico", "cnpj"=>"22.111.111/1111-11", "responsible"=>"Roberto", "address_attributes"=>{"zip_code"=>16201-010, "number"=>257, "street"=>"R. Dr. Carlos Carvalho Rosa", "neighborhood"=>"Patrimônio Silvares", "city"=>"Birigui", "state"=>"São Paulo", "complement"=>"", "loc"=>[-21.2887222, -50.34439450000002]}, "contact_attributes"=>{"ddd_phone"=>"18", "phone"=>"11 1111 1111", "ddd_cellphone"=>"18", "cellphone"=>"11 1111 1111", "email"=>"centromedico@teste.com.br"}, "user_attributes"=>{"email"=>"centromedico@doando.se", "password"=>"123123", "password_confirmation"=>"123123"}})